...
let g:colors_name='elvis-space-vim'
...
call s:hi('Exception'  , 203 , ''  , 'None' , 'None')
call s:hi('Function'   , 169 , ''  , 'None' , 'None')
...
call s:hi('MatchParen', 171 , s:bg0, 'bold,underline', 'bold,underline')
hi Search       guifg=#292b2e guibg=#86dc2f
hi MatchParen   guifg=#d75fff guibg=NONE
...
hi SVDPink    guifg=#ff5fff ctermfg=207
...
hi pythonException       ctermfg=68  guifg=#5f87d7 cterm=bold gui=bold
" ctermfg=161 guifg=#CC3366 cterm=bold gui=bold
